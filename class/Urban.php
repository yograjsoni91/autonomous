...
class Urban implements MappingInterface {
    ...
    public $drop_range_percentage = 25;
    public $drop_speed_limit = 25;
    public $garage_distance = 20;
    ...
    public function distanceMapping() {
        ...
        while ($this->distance_covered < $this->total_distance) {
            ...
            $this->fuel_range = $this->fuel_range - (($this->fuel_range * ($this->drop_range_percentage/100)) + $this->from_fuel);
    ...
    public function totalSpentTime(){
        $urban_speed_limit = self::SPEED_LIMIT - (self::SPEED_LIMIT * ($this->drop_speed_limit/100));
